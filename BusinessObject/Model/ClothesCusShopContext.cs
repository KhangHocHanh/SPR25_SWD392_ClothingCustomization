...
public partial class ClothesCusShopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__6DB38D4EBDFBE48E");
        ...
        {
            entity.HasKey(e => e.CustomizeProductId).HasName("PK__Customiz__21B784E86E8D8552");
        ...
        {
            entity.HasKey(e => e.DesignAreaId).HasName("PK__DesignAr__FA8C6C4C5132727C");
        ...
        {
            entity.HasKey(e => e.DesignElementId).HasName("PK__DesignEl__4221EE4DDD2A533A");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__CD3992F8B2D5A801");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__8C1160B563DEFD3B");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__F1E4639B4E7FA30A");
        ...
        {
            entity.HasKey(e => e.OrderStageId).HasName("PK__OrderSta__B46B8F726AC7E715");

            entity.ToTable("OrderStage");

            entity.Property(e => e.OrderStageId).HasColumnName("OrderStage_ID");
            entity.Property(e => e.OrderId).HasColumnName("Order_ID");
            entity.Property(e => e.OrderStageName).HasMaxLength(50);
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__DA6C7FE136DA6D91");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__9834FB9AF76F540F");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__D80AB49BB75C49AA");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__206D91904AE3F7E6");
